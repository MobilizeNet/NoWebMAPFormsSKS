...
#region "Windows Form Designer generated code "
      ...
      private void InitializeComponent()
      {
         ...
         this.dtRequired.Font = new Mobilize.Web.Font("Microsoft Sans Serif", 8.25f, Mobilize.Web.FontStyle.Regular, Mobilize.Web.GraphicsUnit.Point, 0);
         ...
         this.lvCustomers.Font = new Mobilize.Web.Font("Microsoft Sans Serif", 8.25f, Mobilize.Web.FontStyle.Regular, Mobilize.Web.GraphicsUnit.Point, 0);
         ...
         this.dtPromised.Font = new Mobilize.Web.Font("Microsoft Sans Serif", 8.25f, Mobilize.Web.FontStyle.Regular, Mobilize.Web.GraphicsUnit.Point, 0);
         ...
         this.RefreshClientCustomChanges += new Mobilize.Web.RefreshClientCustomChangesEventHandler(this.ReloadListViewData);
         this.lvCustomers.ItemClick += new Mobilize.Web.ListViewItemClickEventHandler(this.lvCustomers_ItemClick);
